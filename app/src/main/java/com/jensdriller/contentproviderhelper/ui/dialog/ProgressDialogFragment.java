...
public class ProgressDialogFragment<Params, Progress, Result> extends DialogFragment {
	...
	private void setDialogAsyncTask(DialogAsyncTask<Params, Progress, Result> asyncTask) {
	...
	void setup(DialogAsyncTask<Params, Progress, Result> asyncTask, Listener<Progress, Result> listener, boolean retainInstance) {
