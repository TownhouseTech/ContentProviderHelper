...
public class QueryWithFilterDialog extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		ColumnList columnList = bundle.getParcelable(ARG_COLUMN_LIST);
		...
		SpinnerAdapter columnsSortByAdapter = new ArrayAdapter<>(getActivity(), R.layout.simple_spinner_item, columns);
